...
function EstimateWeatherimg(weather) {
  if (weather === '晴') {
    $('.instrument').css("background-image", "url(./images/天气_晴.jpg)");
    ...
    $('.instrument').css("background-image", "url(./images/天气_下雨.jpg)");
  } else if (weather === '暴雨') {
    $('.instrument').css("background-image", "url(./images/天气_下雨.jpg)");
  } else if (weather === '阴转小雨') {
    $('.instrument').css("background-image", "url(./images/天气_下雨.jpg)");
  } else if (weather === '阴') {
    $('.instrument').css("background-image", "url(./images/天气_阴天.jpg)");
  } else if (weather === '多云转阴') {
    $('.instrument').css("background-image", "url(./images/天气_阴天.jpg)");
  } else if (weather === '晴转阴') {
    $('.instrument').css("background-image", "url(./images/天气_阴天.jpg)");
  } else if (weather === '晴转多云') {
    $('.instrument').css("background-image", "url(./images/天气_多云.jpg)");
    ...
    $('.instrument').css("background-image", "url(./images/天气_下雪.jpg)");
    ...
    $('.instrument').css("background-image", "url(./images/天气_雾天.jpg)");
  } else if (weather === '霾') {
    $('.instrument').css("background-image", "url(./images/天气_霾.jpg)");
  } else {
    alert('没有你要的信息')
  }
}